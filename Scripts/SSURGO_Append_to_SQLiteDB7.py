...
#
#
# Dec 10. Trying to clean out all arcpy except for Progressor and the Append_ArcPy function.
#
...
# ===================================================================================
def SSURGOVersionDB(liteCur, tblName):
    # Get SSURGO version from the Template database "SYSTEM Template Database Information" table and
    # compare with version.txt file in tabular folder.
    #
    # Not yet implemented. Should really create a new table for SSURGO-Lite DB in order to implement properly.
    ...
    #
    # The third number is the Metadata Version.  See section “Base Metadata Version” in
    # this same report for additional information.
    #
    ...
    try:
        ...
        #systemInfo = os.path.join(templateDB, "system_templatedatabaseinformation")

        querySaverest = "SELECT saverest FROM " + tblName + " WHERE areasymbol = '?'"
