...
window.geometry('600x750')                 # Menu size
...
lbxDownloads = tk.Listbox(master=frmBottom, listvariable=downloadList, width=15, height=20, selectmode='multiple')
lbxDownloads.grid(row=1, column=0, rowspan=4, columnspan=1, sticky="W")
