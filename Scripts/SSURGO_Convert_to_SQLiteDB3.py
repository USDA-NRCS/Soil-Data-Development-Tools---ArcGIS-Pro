# SSURGO_Convert_to_SQLiteDB3.py

# Import data from SSURGO exports (.txt) to an SQLite database. Import shapefiles using arcpy.AppendFeatures.
#
# Using a template database with attribute table schema. Month table is pre-populated.
#
# Tabular import is sequential by table iterating throug all survey areas.
#
# This is the first version that has functions that can handle OGR spatial import and retains the old
# function which uses arcpy.Append.
#
# This version CANNOT handle template databases with OBJECTID field in attribute tables.
#
...
def ImportTabularSQL1(newDB, pathList, dbVersion, tableList, conn, liteCur):
    ...
    try:
        ...
        # Identify cointerp columns to be removed in 'diet'
        ...
        for txtFile in txtFiles:
            ...
            if tbl != 'cointerp':
                ...
                #PrintMsg(".\tCointerp Fields: " + ",  ".join(fldNames), 0)
