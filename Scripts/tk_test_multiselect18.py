...
window.geometry('600x600')                 # Menu size
...
frmButtons.grid(row=1,column=0, columnspan=4, sticky="ENW")
...
frmBottom.grid_rowconfigure(1, weight=9)
frmBottom.grid_columnconfigure(0, weight=1)
frmBottom.grid_columnconfigure(1, weight=4)
frmBottom.grid_columnconfigure(2, weight=2)
...
# , font=("Helvetica", 12)
lblDownloads = tk.Label(master=frmBottom, text = "Select SSURGO Datasets to Import", padx=2, pady=2)
...
lbxDownloads.grid(row=1, column=0, columnspan=3, sticky="W")
