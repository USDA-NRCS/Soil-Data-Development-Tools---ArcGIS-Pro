...
root = tix.Tk()                           # Menu frame
#root = tk.Tk()                           # Menu frame

root.title('SSURGO Data Picker - By Areasymbol')          # Title bar for menu
root.geometry('600x900')                 # Menu size
...
root.grid_rowconfigure(0, weight=10)     # entries frame
root.grid_rowconfigure(1, weight=2)      # button frame
root.grid_rowconfigure(2, weight=20)     # listbox and status messages
#root.grid_rowconfigure(3, weight=20)     # listbox and status messages
...
#
bgEntries = "cyan"
frmEntries = tk.Frame(master=root, width=150, height=175, relief=tk.RAISED, borderwidth=5, bg=gray)
...
bgButtons = "gray1"
frmButtons = tk.Frame(master=root, width=150, height=40, relief=tk.RAISED, borderwidth=5, bg=gray)
...
bgBottom = "#C0C0C0"
frmBottom = tk.Frame(master=root, width=100, relief=tk.RAISED, borderwidth=5, bg=gray)
...
b0 = Balloon(root.winfo_toplevel())
b0.bind_widget(entFilter, balloonmsg="Enter wildcard for soil survey areasymbol")
...
b1 = Balloon(root.winfo_toplevel())
...
b2 = Balloon(root.winfo_toplevel())
...
b3 = Balloon(root.winfo_toplevel())
...
b4 = Balloon(root.winfo_toplevel())
...
b5 = Balloon(root.winfo_toplevel())
...
b6 = Balloon(root.winfo_toplevel())
...
b7 = Balloon(root.winfo_toplevel())
...
b10 = Balloon(root.winfo_toplevel())
...
b11 = Balloon(root.winfo_toplevel())
...
b12 = Balloon(root.winfo_toplevel())
...
b13 = Balloon(root.winfo_toplevel())
...
b14 = Balloon(root.winfo_toplevel())
...
b15 = Balloon(root.winfo_toplevel())
b15.bind_widget(lbxDownloads, balloonmsg="ListBox SSURGO Downloads to Import")

# Label for selection count (status of lbxDownloads)
...
b16 = Balloon(root.winfo_toplevel())
b16.bind_widget(lblCount, balloonmsg=lblText.get())
##lblText.trace_add('write', ShowSelected)
##lblText.trace_add('write', ClearSelection)
##lblText.trace_add('write', SwitchSelection)
##lblText.trace_add('write', SelectAll)
##lblText.trace_add('write', ValidateFilter)
##lblText.trace_add('write', GetDownloads)
