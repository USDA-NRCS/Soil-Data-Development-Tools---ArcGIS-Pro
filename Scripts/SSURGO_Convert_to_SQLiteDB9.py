...
## ===================================================================================
def ImportTabularSQL(newDB, pathList, dbVersion, tableList, conn, liteCur):
...
def main(inputFolder, surveyList, newDB, geogRegion, tmpFolder, templateDB, bSpatialDiet, bAppend):
    ...
    try:
        ...
        # Capture AOI for the collective soil survey areas
        #minX = 180.0
        #minY = 180.0
        #maxX = -180.0
        #maxY = -180.0
        ...
        if len(mupolyList) > 0:
            ...
            if bGeodatabase:
                ...
                bTabular = ImportTabularSQL(newDB, pathList, dbVersion, tableList, conn, liteCur)
...
try:
    if __name__ == "__main__":
        ...
        #vars = [inputFolder, surveyList, newDB, geogRegion, tmpFolder, templateDB, bSpatialDiet, bAppend]

        #for var in vars:
        #    PrintMsg("var: " + str(var), 0)

        bGood = main(inputFolder, surveyList, newDB, geogRegion, tmpFolder, templateDB, bSpatialDiet, bAppend)
