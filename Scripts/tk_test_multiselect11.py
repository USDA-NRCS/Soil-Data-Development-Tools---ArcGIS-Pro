...
frmTop = tk.Frame(master=window, width=200, height=40, relief=tk.RAISED, borderwidth=5)
frmTop.pack(side=tk.TOP, fill=tk.BOTH, expand=True)

# Create frame second from top (entry widgets go here)
frmMiddle= tk.Frame(master=window, width=200, height=160, relief=tk.RAISED, borderwidth=5)
...
btnFolder = tk.Button(master=frmMiddle, image=folderIcon)
