    ...
    try:
        ...
        if len(mupolyList) > 0:
            ...
            if bGeodatabase:
                ...
                if bArcPy:
                    # Use arcpy.Append_management to import shapefiles, regardless of database format.
                    #
...
try:
    if __name__ == "__main__":
        ...
        #os.environ['PATH'] = os.path.join(basePath, "Support") + ";" + os.environ['PATH']    # insert folder to beginning of path

        
        
        #os.environ["PROJ_LIB"] = os.path.dirname(slExe)  # this setting might be causing proj.db problems with ogr2ogr
