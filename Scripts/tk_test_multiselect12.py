...
def SelectAll(event):
    ...
    msgCount = str(len(cname)) + " survey areas selected for processing"
...
lblCount = tk.Label(master=frmMiddle, text="No survey areas selected for processing", width=30)
lblCount.place(x=5, y=110)
