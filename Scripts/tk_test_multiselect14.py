...
#frmBottom.pack(fill=tk.BOTH, expand=False)
...
#lbxDownloads = tk.Listbox(master=frmBottom, listvariable=downloadList, width=30, height=20, selectmode='extended')
#lbxDownloads.pack(padx=5, pady=35, expand=True, fill="both")
#lbxDownloads.pack(padx=5, pady=35, fill="both")
#lbxDownloads.pack(padx=5, pady=35)
#lbxDownloads.pack(padx=5, pady=35, expand=True)
#lbxDownloads.pack(padx=0, pady=35)
#lbxDownloads.pack( side=tk.LEFT, padx=5, pady=35, expand=True, fill=tk.BOTH)
lbxDownloads.pack( side=tk.LEFT, pady=35, expand=True, fill=tk.BOTH)
